# Generated by Django 3.2 on 2023-02-03 15:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', models.BigIntegerField()),
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('sent_from', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transfers', to='core.account')),
                ('sent_to', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='receives', to='core.account')),
            ],
        ),
        migrations.CreateModel(
            name='Notification',
            fields=[
                ...
                ('fromm', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sends', to=settings.AUTH_USER_MODEL)),
