...
(function($) {
Drupal.behaviors.searchSuggestionsAutocomplete = {
  attach: function (context, settings) {
    $('input.js-vacu-search-suggestions', context)
    .once('searchSuggestionsAutocomplete')
    .each(function() {
      const $el = $(this);
      const $form = $el.closest('form');
      // No event is fired on select, so this is the best we can do without patching autocomplete.js
      $el.bind('autocompleteclose', function(event) {
        if (event.originalEvent && event.originalEvent.type && event.originalEvent.type === 'menuselect') {
          $form.submit();
        }
      });
    });
